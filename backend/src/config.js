...
const namePrefix = "WekexDogVerse";
const description =
	"This is a cool Dog NFT Project.Each NFT generated is Unique.";
...
const extraMetadata = {
	external_url: "https://wekex-dog-verse.netlify.app/", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = "WekexDogVerse";
const CONTRACT_SYMBOL = "WDV";
...
const ROYALTY_ADDRESS = "0x09A0C44E5f206b3220C70b4b0236fBC5e01f2AA1"; // Address that will receive the royalty
